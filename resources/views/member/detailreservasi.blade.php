...
<div class="container">
    ...
    <div class="alert alert-danger">Anda telat mengembalikan barang!</div>
    <div class="card">
        ...
        <div class="card-body">
            <div class="card-list">
                <span class="badge bg-danger">Denda Pembayaran</span>
            </div>
            <div class="card-list">
                <div>Jumlah Denda</div>
                <div>Rp {{$payment['denda']}}</div>
            </div>
            <div class="card-list">
                <div>Total Pembayaran</div>
                <div>Rp {{$payment['total']}}</div>
            </div>
            <div class="card-list">
                <div>Harga Awal</div>
                <div>Rp {{$payment['harga_awal']}}</div>
            </div>
        </div>
    </div>
    @endif
